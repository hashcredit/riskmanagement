...
@Repository("dumai_sourceBaseDao")
public class Dumai_sourceBaseDaoImpl implements Dumai_sourceBaseDao {

	@Autowired
	DruidDataSource dumai_source;

	public JdbcTemplate getTemplate() {
		return new JdbcTemplate(dumai_source);
	}

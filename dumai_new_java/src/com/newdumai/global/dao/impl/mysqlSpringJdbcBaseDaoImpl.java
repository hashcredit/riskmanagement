...
@Repository("mysqlSpringJdbcBaseDao")
public class mysqlSpringJdbcBaseDaoImpl implements Dumai_newBaseDao {

	@Autowired
	DruidDataSource dumai_new;

	public JdbcTemplate getTemplate() {
		return new JdbcTemplate(dumai_new);
	}

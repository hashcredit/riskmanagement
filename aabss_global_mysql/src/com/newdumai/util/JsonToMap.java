...
public class JsonToMap {
	...
	public static Map<String, Object> gson2Map(String json) {
		return new Gson().fromJson(parseJson(json), new TypeToken<Map<String, ?>>() {
		}.getType());
	}

	public static List<Map<String, Object>> gson2List(String json) {
		Gson gson = new Gson();
	...
	public static void main(String[] args) {
		String json = "{\"resCode\":\"0000\",\"resMsg\":\"提交成功\",\"data\":{\"statusCode\":\"2005\",\"statusMsg\":\"一致\"}}";
		// json = json.replace("\"", "");
		// json = json.replace("\\", "");

...
<head>
    ...
    <script type="text/javascript" lang="">
        var page_url = '${ctx}/loanOverdue/handleList.do';
...
//					{field:'hit_count4',align:'center',title:'逾期金额',width:20},
                    {
                        ...
                        formatter: function (value, rec) {
                            var code = rec.code;
                            var btn = "<a onclick='toHandle(\"" + code + "\")'>处理</a>";
                            return btn;
                        }
                    }
                ]],
        ...
        function toHandle(code) {
            window.location.href = "${ctx}/loanOverdue/toHandleList.do?flag=1&code=" + code;
        }

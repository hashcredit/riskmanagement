...
//					{field:'hit_count4',align:'center',title:'逾期金额',width:20},
                    {field:'opt1',title:'查看',width:10,align:'center',
                        formatter:function(value,rec){
                            var orderId=rec.orderid;
                            <%--var url = "${ctx}/loanOverdue/toStages.do?orderId=" + orderId + "&fk_orderinfo_code=" + rec.code;--%>
                            var url = "${ctx}/loanOverdue/toStages.do?orderId=" + orderId + "&name=" + rec.name+ "&typeName=" + rec.typeName+ "&organization=" + rec.organization+ "&phone=" + rec.mobile;
                            var btn = "<a onclick='openWin(\""+url+"\",\"分期明细\")'>查看</a>";
                            return btn;
                        }
                    }
				]],

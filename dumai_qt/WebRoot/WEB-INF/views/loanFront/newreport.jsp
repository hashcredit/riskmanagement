...
<html>
	...
	<script type="text/javascript">
		...
		$(function(){
			$.ajax({
				url:"${ctx}/newreport/report.do?code=${param.code}&type_code=${param.type_code}",
				dataType:"json",
				type:"post",
		...
		function fillReport(report){
			...
			if(companyName=="读脉"){
				var fqzpf = report.fqzpf;
				var fqzpfmx = $("#fqzpfmx").empty();
				if (fqzpf != null) {
					//null时，空数组，防止报错
					$.each(fqzpf.result||[],function(i,value){
						var tr = $("<tr></tr>");
					...
					$("#fqzpf_total_score").text(fqzpf.total_score);
				}
			...
			orderSelect.change(function() {
				...
				window.location.href = "${ctx}/newreport/toReport.do?code="+ orderSelect.val() + "&type_code=" + option.attr("type_code");
			});
		}
		...
		<table width="90%" bgcolor="#ffffff" align="center">
	  	...
	  	<tr>
			...
			<table width="100%">
				...
				<td style="width:49%;vertical-align:top">			
					<table style="width:100%">
						...
						<tr>
							<th>信用评分</th>
							<th><a href="${ctx}/newreport/toXypfResult.do?code=${param.code}">查看数据</a></th>
						</tr>
						</tbody>
			...
			<tr>
					...
					<div class="button3"  onclick="dosubmit();"><span class="submit-btn2" >导&nbsp;&nbsp;出</span></div>
				</td>
			</tr>
			</common:permission>	
		</table>

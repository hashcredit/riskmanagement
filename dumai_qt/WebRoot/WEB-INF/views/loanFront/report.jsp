...
<head>
	...
	<script src="${ctx}/static/dumai/loanFront/js/assess.js"></script>
	
</head>
	
<body ng-controller="markController">
	<div class="contentt" style="background:#fff;position: relative" id="baseReport">
		<div class="evaluate">
			<div class="left">
				<h2>信用评估报告</h2>
				<div class="lbk">
					<p>编号：<span ng-bind="loanReportFront.DeviceNumber">DMYM_X0003 2016.04.14</span></p>
					<p>评估分数：<span ng-bind="">320分</span></p>
	...
	<div class="rightBox" style="width: 90%;left: 240px;top: 0;position: absolute;" id="rightBox">

		<div class="main">
				<table border="0" cellspacing="0" cellpadding="0" class="main1">
								<tr>
									<th colspan="5">
								...
								<tr>
									<td class="status" colspan="2">
										<span>手机号码：</span>
										<span ng-bind="loanReportFront.mobile">15234137433</span>
									</td>
									<td class="status" colspan="2">
										<span>身份证号码：</span>

...
<div id="baseReport">
	<div class="content" style="position: relative">
		...
		<div class="rightBox" style="width: 90%;left: 240px;top: 0;position: absolute;height: 100%;">

			<div class="main">
				<table border="0" cellspacing="0" cellpadding="0" class="main1" style="width:100%">
						<tr>
							<th colspan="5">
								<h1 id="tag1">读脉风险管理报告
								<!-- <i>已通过</i> -->
                                ...
                                <!-- <div class="back">
									<button onclick="ClosePadWin()">返回</button>
								</div> -->
							</th>
						</tr>
						<tr>
							<td rowspan="6" style="width: 15%;text-indent: 0;">
								<img data-ng-src="{{loanReportFront.card_photo}}" alt="{{loanReportFront.name}}" class="cont" style="width:95%;">
							</td>
						</tr>
						<tr>
							<td class="colW">
								<span>姓名：</span>
								<span ng-bind="loanReportFront.name"></span>
							</td>
							<td class="colW">
								<span>性别：</span>
								<span ng-bind="sex"></span>
							</td>
							<td class="colW">
								<span>年龄：</span>
							...
							<td class="colW">
								<span>婚姻：</span>
								<span ng-bind="loanReportFront.married"></span>
							</td>
						</tr>
						<tr>
							...
							<td class="status" colspan="2">
								<span>身份证号码：</span>
								<span ng-bind="loanReportFront.card_num"></span>
							</td>
						</tr>
						<tr>
							<td class="status" colspan="2">
								<span>身份证地址：</span>
								<span ng-bind="loanReportFront.address"></span>
							</td>
							<td class="status" colspan="2">
								<span>现居住地：</span>
								<span ng-bind="loanReportFront.address"></span>
						...
						<tr>
							<td class="status" colspan="2">
								<span>紧急联系人1：<span id='LINKPERSION1'></span> </span>
								<span ng-bind="loanReportFront.linkname1"></span>
							</td>
							<td class="status" colspan="2">
								<span>紧急联系人2：<span id='LINKPERSION2'></span> </span>
								<span ng-bind="loanReportFront.linkname2"></span>
							</td>
						</tr>
						<tr>
							<td class="status" colspan="2">
								<span>工作单位：</span>
								<span ng-bind="loanReportFront.profession" style="width:78%"></span>
							</td>
							<td class="status" colspan="2">
								<span>固定收入 ：</span>
								<span ng-bind="loanReportFront.income"></span>
							</td>
						</tr>
					</table>

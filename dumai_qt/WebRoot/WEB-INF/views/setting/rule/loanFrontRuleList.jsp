...
<html lang="en" ng-app="myRule">
	...
	<%-- 	<script charset="utf-8" type="text/javascript" src="${ctx}/static/script/lib/jquery.min.js"></script> --%>
		...
		<script charset="utf-8" type="text/javascript" src="${ctx}/static/dumai/loanFront/js/ruleFrontController.js"></script>
	</head>
<body>
<div id="menuRule" ng-controller="myMenu3">
    <div class="header">
        <ul>
            ...
            <h5>[ <i ng-bind="username" class="user_name_right"></i> ]<a href="${ctx}/logout.do"><span class="spriteIcon"></span></a></h5>
       </ul>
                    ...
                    <div class="ruleContentBox">
                        ...
                        <ul class="square square2">
                            ...
                            <li ng-repeat="lieData in lieDatas">
                                ...
                                <div class="{{lieData.statusflag}} ruleButton" ng-click="changeItem2(lieData,$event)"></div>

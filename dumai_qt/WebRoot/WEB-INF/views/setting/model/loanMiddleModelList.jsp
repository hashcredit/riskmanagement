...
<html lang="en" ng-app="myRule">
	<head>
		...
		<script charset="utf-8" type="text/javascript" src="${ctx}/static/dumai/loanMiddle/js/ruleMiddleController.js"></script>
        ...
        <div class="info_content" >
            <div class="left" style='overflow:hidden'>
                ...
                <div class="business_type">
                    ...
                    <ul class="waterBox" >
                        <li><span class="ruleBox"></span><a href="${ctx}/rule/toLoanMiddleRuleList.do"">规则池</a><i ng-class="{OFF:'bg1',ON:'bg2'}[flagNF]">启用</i></li>
                        <li><span class="modelBox"></span><a href="${ctx}/rule/toLoanMiddleModelList.do">模型池</a><i ng-class="{OFF:'bg2',ON:'bg1'}[flagNF]">停用</i></li>
                    </ul>
                    ...
                    <div class="ruleContentBox">
                        ...
                        <ul class="square square2">
                         ...
                         <ul class="square square3">
                            <h4>量化定价</h4>
                            <li ng-repeat="power3Ary in power3Arys">
                                <div class="rule_content"><span class="rule_icon {{power3Ary.icon}}"></span></div>
                                <div class="rule_tit"><p style="margin-bottom: 8px" ng-bind="power3Ary.name" class="getRule_title"></p><p ng-bind="power3Ary.descrite"></p></div>
                                <div class="{{power3Ary.statusflag}}" ng-click="changeItem(power3Ary)"></div>
                            </li>
                        </ul>
                    </div>

...
var td=$("<td rowspan=\""+opts.frozenColumns.length+"\"><div class=\"datagrid-header-rownumber\">"+opts.rownumberHeader+"</div></td>");
if($("tr",t).length==0){

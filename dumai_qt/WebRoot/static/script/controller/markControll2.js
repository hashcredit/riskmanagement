 ...
 */
var myMark2 = angular.module('myMark2', []);
myMark2.controller('markControll2',['$scope','$http','$filter',function ($scope,$http,$filter) {
    ...
    $scope.reportFlag2=true;$scope.detailFlag=false;$scope.liListFlag1=false;$scope.liListFlag2=false;$scope.liListFlag3=false;$scope.tongzhuFlag=false;$scope.moveFlag=false;$scope.litiFlag=false;$scope.duoFlag=false;
